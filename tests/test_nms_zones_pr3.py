...
from adapter.timonel import PerceptionEvent, SCHEMA_VERSION, _normalize_detection
...
class CrossCapClassIdTests(unittest.TestCase):
    ...
    def test_remap_uses_entity_type_not_tile_label_map(self) -> None:
        ...
        # Remap: tm_det_to_detections debe usar cross-cap, no tile.
        face = tm_det_to_detections(
            {
                "track_id": "f-1",
                "label": "face",
                "score": 0.9,
...
class TimonelZonesAdditiveTests(unittest.TestCase):
